...
<script>
  import {insertMessage} from '@/api/user.js';
export default {
    props: {},
    data() {
        return {
    ...
    methods: {
         ...
         */
        submit: function() {
          insertMessage(sessionStorage.getItem("userName"),this.dataForm.content,this.dataForm.email,this.dataForm.phone).then((response)=>{
          })
            var self = this;
