...
//
// 修改密码
export function userupdatePassword(username,password) {
  return request({
...
//teacher课程管理
export function lessonselectLessonByTeacher(current,size,username,schoolId) {
  return request({
    url: baseURL + '/lesson/selectLessonByTeacher.do',
    method: 'get',
    params:{
      current:current,
      size:size,
